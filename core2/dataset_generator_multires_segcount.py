...
#     print("Wrote {} random patches to {} with patch size {}".format(count,write_dir,patch_size))
    ...
    # def random_generator(self, BATCH_SIZE, normalize = 1, gbnorm = 0):
    ...
    #     while True:
    #         X, y = self.random_patch(BATCH_SIZE, normalize, gbnorm)
