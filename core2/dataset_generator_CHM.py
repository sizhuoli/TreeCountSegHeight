...
# # weighed MSE and upsampled CHM             
# class DataGenerator():
#     """The datagenerator class. Defines methods for generating patches randomly and sequentially from given frames.
#     """

#     def __init__(self, input_image_channel, patch_size, frame_list, frames, center_weights = 10, augmenter=None):
#         """Datagenerator constructor
...
#             fn = np.random.choice(self.frame_list)
#             frame = self.frames[fn]
#             patch, chm = frame.random_patch(self.patch_size, normalize)
#             patches.append(patch)
#             chms.append(chm)
#             # print("chm shape", chm.shape)
#         data = np.array(patches)
...
#                 chm = y[...,[0]]
#                 center = y[...,[1]]
#                 center[center>=0.5] = self.center_weights #try lower weights
#                 center[center<0.5] = 1
                
#                 ann_joint = np.concatenate((chm,center), axis=-1)
#                 yield X, ann_joint
#             else:
