...
#         self.base_dir = './extracted_data_2aux_v4/'
#         self.image_type = '.png'
# #         self.ndvi_fn = 'ndvi'
# #         self.pan_fn = 'pan'
...
#         self.all_channels = self.image_channels + 2 + 3 + 3 # multi res output (label and weights)
...
#         self.input_label_channel = [4, 5, 6, 7]
#         self.input_weight_channel = [8, 9, 10, 11]
...
#         # (Input + Output) channels
#         self.image_channels = len(self.extracted_filenames)
#         self.all_channels = self.image_channels + 2
#         self.patch_size = (256,256,self.all_channels) # Height * Width * (Input + Output) channels
#         # self.patch_size = (512,512,self.all_channels) # Height * Width * (Input + Output) channels
#         # # When stratergy == sequential, then you need the step_size as well
#         # step_size = (128,128)
...
#         # dir where extrected images are
#         # self.base_dir = './extracted_build_v01/'
#         self.base_dir = './extracted_data_2aux_v4_cleaned_centroids_detCHM/'
#         # self.base_dir2 = './extracted_data_2aux_v4_cleaned_centroids_linear_addons/'
#         self.image_type = '.png'
# #         self.ndvi_fn = 'ndvi'
# #         self.pan_fn = 'pan'
#         self.extracted_filenames = ['red', 'green', 'blue', 'infrared', 'ndvi']
...
#         self.LOSS_NAME = 'weightmapTversky'
#         self.LOSS2 = 'MSE100'
#         self.model_name = 'complex5'
#         self.sufix = '_detCHM'
...
# # multi tasks (seg count) simple setting: grayscale images
# import os
# from functools import reduce
...
#         # self.base_dir = './extracted_build_v01/'
#         # self.base_dir = './extracted_data_2aux_v4_cleaned_centroids_detCHM_cleanedCHM_norm_cleaned_nolinear/'
#         self.base_dir = './extracted_data_2aux_v4_cleaned_centroids/'
#         self.image_type = '.png'
# #         self.ndvi_fn = 'ndvi'
# #         self.pan_fn = 'pan'
#         self.grayscale = 1
...
#         self.patch_generation_stratergy = 'random' # 'random' or 'sequential'
#         # (Input + Output) channels
#         self.image_channels = len(self.channel_names1) + len(self.channel_names2)
#         self.all_channels = self.image_channels + 3
#         self.patch_size = (256,256,self.all_channels) # Height * Width * (Input + Output) channels
#         # self.patch_size = (512,512,self.all_channels) # Height * Width * (Input + Output) channels
#         # # When stratergy == sequential, then you need the step_size as well
...
#         # Probability with which the generated patches should be normalized 0 -> don't normalize, 1 -> normalize all
#         self.normalize = 0.4
#         # globally normalize the patches
#         self.gbnorm = 0
#         # upscale for aux chm layer
#         self.upscale_factor = 2
...
#         # dir where extrected images are
#         # self.base_dir = './extracted_build_v01/'
#         self.base_dir = './extracted_data_2aux_v4_cleaned_centroids_chmmax9p/'
#         self.image_type = '.png'
# #         self.ndvi_fn = 'ndvi'
# #         self.pan_fn = 'pan'
#         self.extracted_filenames = ['red', 'green', 'blue', 'infrared', 'ndvi']
...
#         # self.annotation_fn = 'annotation'
#         # self.weight_fn = 'boundary'
#         # self.density_fn = 'count_kernel'
#         self.chm_fn = 'chm_kernel'
#         # self.boundary_weights = 5
#         self.single_raster = False
#         self.aux_data = True
#         # Patch generation; from the training areas (extracted in the last notebook), we generate fixed size patches.
...
#         # (Input + Output) channels
#         self.image_channels = len(self.channel_names1)
#         self.all_channels = self.image_channels
#         self.patch_size = (256,256,self.all_channels) # Height * Width * (Input + Output) channels
#         # self.patch_size = (512,512,self.all_channels) # Height * Width * (Input + Output) channels
#         # # When stratergy == sequential, then you need the step_size as well
#         # step_size = (128,128)
...
#         # self.input_weight_channel = [self.image_channels+1]
#         # self.input_density_channel = [self.image_channels+2]
#         # self.input_chm_channel = [self.image_channels+3]
#         # self.label_weight_channel = [self.image_channels, self.image_channels+1]
...
#         self.LOSS_NAME = 'weightedMSE2e'
#         # self.LOSS2 = 'adaptiveMse'
#         self.model_name = 'complex5_noBN'
#         self.chs = reduce(lambda a,b: a+str(b), self.extracted_filenames, '')

        
#         self.model_path = './saved_models/chmdensity/'




# # seg count chm density
# import os
# from functools import reduce
...
#         self.OPTIMIZER_NAME = 'Adam'
#         self.LOSS_NAME = 'weightmapTversky'
#         self.LOSS2 = self.LOSS3 = 'Mse01'
#         self.model_name = 'complex5_split_simplified'
#         self.chs = reduce(lambda a,b: a+str(b), self.extracted_filenames, '')

        
        
#         self.model_path = './saved_models/segcountdensitychm/'
