...
class Configuration:
    ...
    def __init__(self):
        ...
        self.trained_model_paths = [
                                    '/mnt/ssda/denmark10cm/saved_models/segcountdensity/trees_20210620-0202_Adam_e4_redgreenblue_256_84_frames_weightmapTversky_MSE100_5weight_complex5.h5'
                                    # '/mnt/ssda/denmark10cm/saved_models/segcountdensity/trees_20210620-0205_Adam_e4_infraredgreenblue_256_84_frames_weightmapTversky_MSE100_5weight_complex5.h5',
                                    ]
