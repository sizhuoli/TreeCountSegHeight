...
if not os.path.exists(config.model_path):
    os.makedirs(config.model_path)
model_path = os.path.join(config.model_path,'trees_RGB2CHM_{}_{}_{}_{}_{}_{}_frames_{}.h5'.format(timestr,OPTIMIZER_NAME,LOSS_NAME,chs,config.input_shape[0], len(all_files_c1), config.model_name))
